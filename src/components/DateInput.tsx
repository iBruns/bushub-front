        ...
        <div>
            <label className=" flex flex-col space-y-2">
                ...
                <div className="relative block">
                    ...
                    <input readOnly value={value} type='text' id={inputId} name={inputName} className={`pl-9 pr-3 w-36 placeholder:text-stone-700 text-stone-200 rounded-md h-9 px-4 bg-stone-800/70 text-sm ${styleSettings}`} placeholder={InputPlaceholder} />
                </div>
            </label>
