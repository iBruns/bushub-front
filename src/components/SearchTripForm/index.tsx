...
export default function SearchTripForm() {
  ...
  return (
    <>
      <div ref={stickyControlerRef} className=" h-[14vh] mb-16 w-full " />
        ...
        >
          ...
          >
            <Input
              ...
              inputName="origem"
              inputId="origem"
              InputPlaceholder="digite a cidade de origem"
            />
            <button
            ...
            <Input
              ...
              inputName="destino"
              inputId="destino"
              InputPlaceholder="digite a cidade de destino"
            />
          ...
          {!isSticked ? (
            <Button
              className={
                !isSticked
                  ? "rounded-lg py-7 px-8 w-full"
                  : "rounded-lg  p-0 m-0 h-0 w-0"
              }
